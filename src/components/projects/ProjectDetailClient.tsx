...
// CHANGED: previously this component unwrapped `params: Promise<{id}>`
// itself, which forced the whole file to be "use client" and blocked
// metadata. Now the server-side page.tsx (app/projects/[id]/page.tsx)
// resolves the id and hands it down as a plain prop.
  ...
  const fetchProject = async (id: string) => {
    try {
      ...
      setProject({
        ...
        description:
          "This project details could not be loaded. Please try again later.",
        thumbnail: "/project-placeholder.jpg",
        technologies: ["Error Loading"],
        liveUrl: "#",
        githubUrl: "#",
        featured: false,
        category: "OTHERS",
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="mb-16">
            <Link
              href="/projects"
              className="inline-flex items-center gap-2 text-[#D345A8] dark:text-[#D345A8] hover:text-purple-500 dark:hover:text-purple-300 transition-colors pt-20 mb-8 group"
            >
              <ArrowLeft
                size={18}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  {project.liveUrl && project.liveUrl !== "#" ? (
                    ...
                    <button
                      disabled
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-gray-400 to-gray-500 rounded-lg text-white font-semibold cursor-not-allowed flex items-center justify-center gap-2 group min-w-[200px] opacity-60"
                    >
                      <Globe size={18} />
                  ...
                  {project.githubUrl && project.githubUrl !== "#" ? (
                    ...
                    <button
                      disabled
                      className={`flex-1 px-6 py-3 rounded-lg font-semibold cursor-not-allowed flex items-center justify-center gap-2 group min-w-[200px] opacity-60 ${
                        currentTheme === "dark"
