          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700 outline-none focus:ring-2 focus:ring-purple-500 dark:text-white"
              />
            </div>
